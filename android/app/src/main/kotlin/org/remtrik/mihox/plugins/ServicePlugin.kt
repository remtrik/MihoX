...
import org.remtrik.mihox.Service
import org.remtrik.mihox.common.Components
...
class ServicePlugin :
    ...
    override fun onMethodCall(call: MethodCall, result: MethodChannel.Result) {
        when (call.method) {
            ...
            "saveParams" -> {
                ...
                org.remtrik.mihox.common.SavedParams.saveQuickStartParams(init, params, state)
                result.successOnMain(true)
            }
    ...
    private fun onServiceDisconnected(message: String) {
        ...
        // recycled — NOT that the tunnel died. MihoXVpnService is START_STICKY + foreground
    ...
    private fun handleShowSubscriptionNotification(call: MethodCall, result: MethodChannel.Result) {
        ...
        runCatching {
            ...
            val builder = NotificationCompat.Builder(ctx, GlobalState.SUBSCRIPTION_NOTIFICATION_CHANNEL)
                .setSmallIcon(org.remtrik.mihox.service.R.drawable.ic_notification)
