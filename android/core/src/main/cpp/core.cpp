...
Java_org_remtrik_mihox_core_Core_nativeStartTun(JNIEnv *env, jobject, const jint fd, jobject cb) {
...
Java_org_remtrik_mihox_core_Core_stopTun(JNIEnv *, jobject) {
    stopTun();
}

extern "C"
JNIEXPORT void JNICALL
Java_org_remtrik_mihox_core_Core_invokeAction(JNIEnv *env, jobject, jstring data, jobject cb) {
    const auto interface = new_global(cb);
...
extern "C"
JNIEXPORT void JNICALL
Java_org_remtrik_mihox_core_Core_quickStart(JNIEnv *env, jobject,
...
extern "C"
JNIEXPORT void JNICALL
Java_org_remtrik_mihox_core_Core_setEventListener(JNIEnv *env, jobject, jobject cb) {
    if (cb == nullptr) {
...
extern "C"
JNIEXPORT void JNICALL
Java_org_remtrik_mihox_core_Core_setState(JNIEnv *env, jobject, jstring s) {
...
extern "C"
JNIEXPORT void JNICALL
Java_org_remtrik_mihox_core_Core_updateDns(JNIEnv *env, jobject, jstring s) {
    scoped_string c_s = get_string(s);
    updateDns(c_s);
}
...
Java_org_remtrik_mihox_core_Core_getTraffic(JNIEnv *env, jobject) {
    RETURN_GO_STRING(getTraffic());
}

extern "C"
JNIEXPORT jstring JNICALL
Java_org_remtrik_mihox_core_Core_getTotalTraffic(JNIEnv *env, jobject) {
    RETURN_GO_STRING(getTotalTraffic());
}

extern "C"
JNIEXPORT jstring JNICALL
Java_org_remtrik_mihox_core_Core_getRunTime(JNIEnv *env, jobject) {
    RETURN_GO_STRING(getRunTime());
}

extern "C"
JNIEXPORT jstring JNICALL
Java_org_remtrik_mihox_core_Core_getCurrentProfileName(JNIEnv *env, jobject) {
    RETURN_GO_STRING(getCurrentProfileName());
}

extern "C"
JNIEXPORT jstring JNICALL
Java_org_remtrik_mihox_core_Core_getAndroidVpnOptions(JNIEnv *env, jobject) {
    RETURN_GO_STRING(getAndroidVpnOptions());
}

extern "C"
JNIEXPORT void JNICALL
Java_org_remtrik_mihox_core_Core_resetConnections(JNIEnv *, jobject) {
    resetConnections();
}

extern "C"
JNIEXPORT void JNICALL
Java_org_remtrik_mihox_core_Core_startListener(JNIEnv *, jobject) {
    startListener();
}

extern "C"
JNIEXPORT void JNICALL
Java_org_remtrik_mihox_core_Core_stopListener(JNIEnv *, jobject) {
    stopListener();
}
...
JNI_OnLoad(JavaVM *vm, void *) {
    ...
    const auto c_invoke_interface = find_class("org/remtrik/mihox/core/InvokeInterface");
