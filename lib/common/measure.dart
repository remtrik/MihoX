...
class Measure {
  ...
  double get bodyMediumHeight => _measureMap.updateCacheValue(
    "bodyMediumHeight",
    () =>
        computeTextSize(Text("X", style: context.textTheme.bodyMedium)).height,
  )!;
  ...
  double get labelSmallHeight => _measureMap.updateCacheValue(
    "labelSmallHeight",
    () =>
        computeTextSize(Text("X", style: context.textTheme.labelSmall)).height,
  )!;

  double get labelMediumHeight => _measureMap.updateCacheValue(
    "labelMediumHeight",
    () =>
        computeTextSize(Text("X", style: context.textTheme.labelMedium)).height,
  )!;

  double get titleLargeHeight => _measureMap.updateCacheValue(
    "titleLargeHeight",
    () =>
        computeTextSize(Text("X", style: context.textTheme.titleLarge)).height,
  )!;

  double get titleMediumHeight => _measureMap.updateCacheValue(
    "titleMediumHeight",
    () =>
        computeTextSize(Text("X", style: context.textTheme.titleMedium)).height,
  )!;
}
