...
class _FocusableTapState extends State<_FocusableTap> {
  ...
  Widget build(BuildContext context) {
    ...
    return FocusableActionDetector(
      ...
      // (mihox models also export an `Action` class). Context inference from
...
class HeroConnect extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final serviceName = _decodeBase64(headers['mihox-servicename']) ?? appName;
    final logoUrl = _decodeBase64(headers['mihox-servicelogo']);
    ...
    final buyPlanUrl = headers['mihox-buyplan'];
    final buyTrafficUrl = headers['mihox-buytraffic'];
    ...
    // `mihox-serverinfo` header: its selected leaf host (the real location),
    ...
    final serverInfoHeader = headers['mihox-serverinfo'];
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return ValueListenableBuilder(
      ...
      builder: (_, networkState, _) {
        ...
        return _FocusableTap(
          borderRadius: 18,
          onTap: () => globalState.appController.page = PageLabel.proxies,
          child: Container(
            width: double.infinity,
