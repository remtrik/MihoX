...
part 'generated/mihomo_config.freezed.dart';
part 'generated/mihomo_config.g.dart';
...
@freezed
class MihomoConfigSnippet with _$MihomoConfigSnippet {
  const factory MihomoConfigSnippet({
  ...
  }) = _MihomoConfigSnippet;

  factory MihomoConfigSnippet.fromJson(Map<String, Object?> json) =>
      _$MihomoConfigSnippetFromJson(json);
}

@freezed
class MihomoConfig with _$MihomoConfig {
  const factory MihomoConfig({
  ...
  factory MihomoConfig.fromJson(Map<String, Object?> json) =>
      _$MihomoConfigFromJson(json);

  factory MihomoConfig.safeFormJson(Map<String, Object?>? json) {
    if (json == null) return defaultMihomoConfig;
    try {
      return MihomoConfig.fromJson(json);
    } catch (_) {
      return defaultMihomoConfig;
    }
  }
}
