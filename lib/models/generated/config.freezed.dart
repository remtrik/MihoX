...
@useResult
$Res call({
 String? locale,@JsonKey(fromJson: dashboardWidgetsSafeFormJson) List<DashboardWidget> dashboardWidgets, bool onlyStatisticsProxy, bool autoLaunch, bool silentLaunch, bool autoRun, bool openLogs, bool closeConnections, String testUrl, bool isAnimateToPage, bool autoCheckUpdate, bool showLabel, bool minimizeOnExit, bool hidden, bool developerMode, bool zashboardInApp, bool overrideProviderSettings, bool overrideNetworkSettings, RecoveryStrategy recoveryStrategy, bool? newDashboard
});
...
as bool,zashboardInApp: null == zashboardInApp ? _self.zashboardInApp : zashboardInApp // ignore: cast_nullable_to_non_nullable
as bool,overrideProviderSettings: null == overrideProviderSettings ? _self.overrideProviderSettings : overrideProviderSettings // ignore: cast_nullable_to_non_nullable
...
as RecoveryStrategy,newDashboard: freezed == newDashboard ? _self.newDashboard : newDashboard // ignore: cast_nullable_to_non_nullable
as bool?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? locale, @JsonKey(fromJson: dashboardWidgetsSafeFormJson)  List<DashboardWidget> dashboardWidgets,  bool onlyStatisticsProxy,  bool autoLaunch,  bool silentLaunch,  bool autoRun,  bool openLogs,  bool closeConnections,  String testUrl,  bool isAnimateToPage,  bool autoCheckUpdate,  bool showLabel,  bool minimizeOnExit,  bool hidden,  bool developerMode,  bool zashboardInApp,  bool overrideProviderSettings,  bool overrideNetworkSettings,  RecoveryStrategy recoveryStrategy,  bool? newDashboard)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AppSettingProps() when $default != null:
return $default(_that.locale,_that.dashboardWidgets,_that.onlyStatisticsProxy,_that.autoLaunch,_that.silentLaunch,_that.autoRun,_that.openLogs,_that.closeConnections,_that.testUrl,_that.isAnimateToPage,_that.autoCheckUpdate,_that.showLabel,_that.minimizeOnExit,_that.hidden,_that.developerMode,_that.zashboardInApp,_that.overrideProviderSettings,_that.overrideNetworkSettings,_that.recoveryStrategy,_that.newDashboard);case _:
  return orElse();
...
class _AppSettingProps implements AppSettingProps {
  const _AppSettingProps({this.locale, @JsonKey(fromJson: dashboardWidgetsSafeFormJson)  List<DashboardWidget> dashboardWidgets = defaultDashboardWidgets, this.onlyStatisticsProxy = false, this.autoLaunch = false, this.silentLaunch = false, this.autoRun = false, this.openLogs = false, this.closeConnections = true, this.testUrl = defaultTestUrl, this.isAnimateToPage = true, this.autoCheckUpdate = false, this.showLabel = false, this.minimizeOnExit = false, this.hidden = false, this.developerMode = false, this.zashboardInApp = true, this.overrideProviderSettings = false, this.overrideNetworkSettings = false, this.recoveryStrategy = RecoveryStrategy.compatible, this.newDashboard}): _dashboardWidgets = dashboardWidgets;
...
@override@JsonKey() final  bool zashboardInApp;
...
@override final  bool? newDashboard;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,locale,const DeepCollectionEquality().hash(_dashboardWidgets),onlyStatisticsProxy,autoLaunch,silentLaunch,autoRun,openLogs,closeConnections,testUrl,isAnimateToPage,autoCheckUpdate,showLabel,minimizeOnExit,hidden,developerMode,zashboardInApp,overrideProviderSettings,overrideNetworkSettings,recoveryStrategy,newDashboard]);
...
class _WindowProps implements WindowProps {
  const _WindowProps({this.width = 450, this.height = 900, this.top, this.left});
...
class _VpnProps implements VpnProps {
  const _VpnProps({this.enable = true, this.systemProxy = false, this.ipv6 = true, this.allowBypass = false, this.accessControl = defaultAccessControl});
...
@JsonKey(fromJson: AppSettingProps.safeFromJson) AppSettingProps get appSetting; List<Profile> get profiles; List<HotKeyAction> get hotKeyActions; String? get currentProfileId; bool get overrideDns; NetworkProps get networkProps; VpnProps get vpnProps;@JsonKey(fromJson: ThemeProps.safeFromJson) ThemeProps get themeProps; ProxiesStyle get proxiesStyle; WindowProps get windowProps; MihomoConfig get patchMihomoConfig; ScriptProps get scriptProps;
...
@useResult
$Res call({
@JsonKey(fromJson: AppSettingProps.safeFromJson) AppSettingProps appSetting, List<Profile> profiles, List<HotKeyAction> hotKeyActions, String? currentProfileId, bool overrideDns, NetworkProps networkProps, VpnProps vpnProps,@JsonKey(fromJson: ThemeProps.safeFromJson) ThemeProps themeProps, ProxiesStyle proxiesStyle, WindowProps windowProps, MihomoConfig patchMihomoConfig, ScriptProps scriptProps
});


$AppSettingPropsCopyWith<$Res> get appSetting;$NetworkPropsCopyWith<$Res> get networkProps;$VpnPropsCopyWith<$Res> get vpnProps;$ThemePropsCopyWith<$Res> get themeProps;$ProxiesStyleCopyWith<$Res> get proxiesStyle;$WindowPropsCopyWith<$Res> get windowProps;$MihomoConfigCopyWith<$Res> get patchMihomoConfig;$ScriptPropsCopyWith<$Res> get scriptProps;
...
as bool,networkProps: null == networkProps ? _self.networkProps : networkProps // ignore: cast_nullable_to_non_nullable
...
as WindowProps,patchMihomoConfig: null == patchMihomoConfig ? _self.patchMihomoConfig : patchMihomoConfig // ignore: cast_nullable_to_non_nullable
as MihomoConfig,scriptProps: null == scriptProps ? _self.scriptProps : scriptProps // ignore: cast_nullable_to_non_nullable
as ScriptProps,
  ));
}
/// Create a copy of Config
...
$MihomoConfigCopyWith<$Res> get patchMihomoConfig {
  ...
  return $MihomoConfigCopyWith<$Res>(_self.patchMihomoConfig, (value) {
    return _then(_self.copyWith(patchMihomoConfig: value));
  });
}/// Create a copy of Config
/// with the given fields replaced by the non-null parameter values.
@override
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(fromJson: AppSettingProps.safeFromJson)  AppSettingProps appSetting,  List<Profile> profiles,  List<HotKeyAction> hotKeyActions,  String? currentProfileId,  bool overrideDns,  NetworkProps networkProps,  VpnProps vpnProps, @JsonKey(fromJson: ThemeProps.safeFromJson)  ThemeProps themeProps,  ProxiesStyle proxiesStyle,  WindowProps windowProps,  MihomoConfig patchMihomoConfig,  ScriptProps scriptProps)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Config() when $default != null:
return $default(_that.appSetting,_that.profiles,_that.hotKeyActions,_that.currentProfileId,_that.overrideDns,_that.networkProps,_that.vpnProps,_that.themeProps,_that.proxiesStyle,_that.windowProps,_that.patchMihomoConfig,_that.scriptProps);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(fromJson: AppSettingProps.safeFromJson)  AppSettingProps appSetting,  List<Profile> profiles,  List<HotKeyAction> hotKeyActions,  String? currentProfileId,  bool overrideDns,  NetworkProps networkProps,  VpnProps vpnProps, @JsonKey(fromJson: ThemeProps.safeFromJson)  ThemeProps themeProps,  ProxiesStyle proxiesStyle,  WindowProps windowProps,  MihomoConfig patchMihomoConfig,  ScriptProps scriptProps)  $default,) {final _that = this;
switch (_that) {
case _Config():
return $default(_that.appSetting,_that.profiles,_that.hotKeyActions,_that.currentProfileId,_that.overrideDns,_that.networkProps,_that.vpnProps,_that.themeProps,_that.proxiesStyle,_that.windowProps,_that.patchMihomoConfig,_that.scriptProps);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(fromJson: AppSettingProps.safeFromJson)  AppSettingProps appSetting,  List<Profile> profiles,  List<HotKeyAction> hotKeyActions,  String? currentProfileId,  bool overrideDns,  NetworkProps networkProps,  VpnProps vpnProps, @JsonKey(fromJson: ThemeProps.safeFromJson)  ThemeProps themeProps,  ProxiesStyle proxiesStyle,  WindowProps windowProps,  MihomoConfig patchMihomoConfig,  ScriptProps scriptProps)?  $default,) {final _that = this;
switch (_that) {
case _Config() when $default != null:
return $default(_that.appSetting,_that.profiles,_that.hotKeyActions,_that.currentProfileId,_that.overrideDns,_that.networkProps,_that.vpnProps,_that.themeProps,_that.proxiesStyle,_that.windowProps,_that.patchMihomoConfig,_that.scriptProps);case _:
  return null;
...
@override@JsonKey() final  MihomoConfig patchMihomoConfig;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,appSetting,const DeepCollectionEquality().hash(_profiles),const DeepCollectionEquality().hash(_hotKeyActions),currentProfileId,overrideDns,networkProps,vpnProps,themeProps,proxiesStyle,windowProps,patchMihomoConfig,scriptProps);
...
@override $AppSettingPropsCopyWith<$Res> get appSetting;@override $NetworkPropsCopyWith<$Res> get networkProps;@override $VpnPropsCopyWith<$Res> get vpnProps;@override $ThemePropsCopyWith<$Res> get themeProps;@override $ProxiesStyleCopyWith<$Res> get proxiesStyle;@override $WindowPropsCopyWith<$Res> get windowProps;@override $MihomoConfigCopyWith<$Res> get patchMihomoConfig;@override $ScriptPropsCopyWith<$Res> get scriptProps;
