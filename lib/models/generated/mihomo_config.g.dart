...
_MihomoConfigSnippet _$MihomoConfigSnippetFromJson(Map<String, dynamic> json) =>
...
_MihomoConfig _$MihomoConfigFromJson(Map<String, dynamic> json) =>
    _MihomoConfig(
...
Map<String, dynamic> _$MihomoConfigToJson(_MihomoConfig instance) =>
    <String, dynamic>{
