...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "backupAndRecoveryDesc": MessageLookupByLibrary.simpleMessage(
      "Синхронизация данных через файл",
    ),
    ...
    "compatibleDesc": MessageLookupByLibrary.simpleMessage(
      "Включение приведет к потере части функциональности, но обеспечит полную совместимость с Mihomo",
    ),
    ...
    "restartCoreDesc": MessageLookupByLibrary.simpleMessage(
      "Перезапустить прокси-ядро",
    ),
    "coreStatusRunning": MessageLookupByLibrary.simpleMessage("Работает"),
    "coreStatusRestarting": MessageLookupByLibrary.simpleMessage(
      "Перезапускается...",
    ),
    ...
    "runtimeConfigNotAvailable": MessageLookupByLibrary.simpleMessage(
      "Рантайм конфиг ещё не доступен. Сначала запустите VPN.",
    ),
    ...
    "whitelistModeDesc": MessageLookupByLibrary.simpleMessage(
      "Только выбранные приложения будут использовать VPN. Все остальные — напрямую.",
    ),
    "blacklistModeDesc": MessageLookupByLibrary.simpleMessage(
      "Выбранные приложения обойдут VPN. Все остальные — через VPN.",
    ),
    "hwidNotSupported": MessageLookupByLibrary.simpleMessage(
      "HWID не включен на этом устройстве. Пожалуйста, включите его в настройках приложения.",
    ),
    "coreUpdate": MessageLookupByLibrary.simpleMessage("Обновить ядро"),
    "coreUpdateAvailable": MessageLookupByLibrary.simpleMessage(
      "Доступно обновление",
    ),
    "coreUpdateCurrent": MessageLookupByLibrary.simpleMessage(
      "Актуальная версия",
    ),
    ...
    "reconnect": MessageLookupByLibrary.simpleMessage("Переподключить"),
